...
2.  Note Depth Sensor ID & array/buoy it was deployed with
    ...
    ![](images/sensus FindDepthID.jpg){width="147"}
...
3.  Open Reefnet Sensus Ultra Software (https://reefnet.ca/downloads/)
    ...
    5.  Ensure ID and deployment \# is saved on filename

    6.  Save file in appropriate location (with relevant data)

    7.  Ensure data is saved, and sensor is configured properly (see
        previous sections in this document), and it is ready for the
        next deployment!
