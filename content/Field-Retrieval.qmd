...
6.  Retrieve the line; if a winch is used, ensure that there is a lookout to remove line from winch before reaching the drogue and subsurface components. Do NOT allow the hydrophone array to be pulled directly on the winch.
