...
setwd('Z:\\METADATA\\ADRIFT\\ADRIFT_036\\ADRIFT_036_Depth_Sensus')

#Read in data
rawDepth <- read.csv('ADRIFT_036_Depth_Sensus.csv', header = FALSE)
#rawDepth <- read.csv('15865.csv', header = FALSE)
write.csv(rawDepth, "Z:\\METADATA\\ADRIFT\\ADRIFT_036\\ADRIFT_036_Depth_Sensus\\ADRIFT_036_Depth_Sensus_RAW.csv", row.names = FALSE)
```
...
```{r}
write.csv(finalDepth, "Z:\\METADATA\\ADRIFT\\ADRIFT_036\\ADRIFT_036_Depth_Sensus\\ADRIFT_036_Depth_Sensus.csv", row.names=FALSE)
```
