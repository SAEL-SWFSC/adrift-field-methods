...
setwd('Z:\\METADATA\\ADRIFT\\ADRIFT_042\\ADRIFT_042_Depth_Sensus')

#Read in data
#rawDepth <- read.csv('ADRIFT_042_Depth_Sensus.csv', header = FALSE)
rawDepth <- read.csv('SU-17434.csv', header = FALSE)
write.csv(rawDepth, "Z:\\METADATA\\ADRIFT\\ADRIFT_042\\ADRIFT_042_Depth_Sensus\\ADRIFT_042_Depth_Sensus_RAW.csv", row.names = FALSE)
```
...
```{r}
write.csv(finalDepth, "Z:\\METADATA\\ADRIFT\\ADRIFT_042\\ADRIFT_042_Depth_Sensus\\ADRIFT_042_Depth_Sensus.csv", row.names=FALSE)
```
